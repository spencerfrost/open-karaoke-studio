            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleThemeChange("themeName", e.target.value)
                  }
                >
                ...
                <div className="relative inline-block w-10 mr-2 align-middle select-none">
                  ...
                  <div
                    ...
                    style={{
                      ...
                      transform: settings.theme.darkMode
                        ? "translateX(1rem)"
                        : "translateX(0)",
                    }}
                  ></div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="relative inline-block w-10 mr-2 align-middle select-none">
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor: colors.darkCyan,
                      transform: settings.processing.autoProcessYouTube
                        ? "translateX(1rem)"
                        : "translateX(0)",
                    }}
                  ></div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="relative inline-block w-10 mr-2 align-middle select-none">
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor: colors.darkCyan,
                      transform: settings.display.showAudioVisualizations
                        ? "translateX(1rem)"
                        : "translateX(0)",
                    }}
                  ></div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="relative inline-block w-10 mr-2 align-middle select-none">
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor: colors.darkCyan,
                      transform: settings.display.showProgress
                        ? "translateX(1rem)"
                        : "translateX(0)",
                    }}
                  ></div>
