        ...
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            <p className="text-xs text-muted-foreground italic mb-1">
              ...
              Review and select the most accurate information for both tabs
              before confirming.
            </p>
            <p className="text-xs text-muted-foreground">
              <span className="text-green-500 font-medium">Tip:</span> Look for
              synchronized lyrics with the{" "}
              <span className="px-1 py-0.5 text-xs bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 rounded-full">
                Synchronized
              </span>{" "}
              badge for the best karaoke experience.
            </p>
          </DialogDescription>
        </DialogHeader>
