...
def upgrade() -> None:
    ...
    with op.batch_alter_table('songs', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('itunes_collection_id', sa.Integer(), nullable=True))
        ...
        batch_op.add_column(sa.Column('youtube_thumbnail_urls', sa.Text(), nullable=True))
        ...
        batch_op.add_column(sa.Column('youtube_channel_name', sa.String(), nullable=True))
