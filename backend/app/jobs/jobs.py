...
def process_youtube_job(self, job_id, video_id, metadata):
    ...
    """
    logger.info(f"Starting unified YouTube processing job for job {job_id}")
    ...
    try:
        ...
        song_dir = file_service.get_song_directory(song_id)  # Use song_id for directory
        ...
        return {
            ...
            "instrumental_path": str(file_management.get_instrumental_path_stem(song_dir).with_suffix('.mp3'))
        }
