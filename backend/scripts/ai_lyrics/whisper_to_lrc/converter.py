...
class WhisperToLRCConverter:
    ...
    def _filter_low_confidence_words(self, words: list[Dict[str, Any]]) -> list[Dict[str, Any]]:
    ...
    def _extract_metadata(self,
                         ...
                         filtered_words: list[Dict[str, Any]]) -> Dict[str, Any]:
...
def create_converter(max_gap: float = 2.0,
                    min_words_per_line: int = 2,
                    max_words_per_line: int = 8,
                    target_words_per_line: int = 5,
                    confidence_threshold: float = 0.3) -> WhisperToLRCConverter:
    """
