...
def create_progress_callback(log_interval: int = 10) -> Callable[[ProcessingStats], None]:
    """
...
def estimate_processing_time(num_songs: int, delay: float, api_calls_per_song: float = 1.5) -> float:
    """
    ...
    base_time_per_song = (api_calls_per_song * 0.5) + 0.1  # 0.5s per API call + 0.1s overhead
