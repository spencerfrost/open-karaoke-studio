...
class TestFileService:
    ...
    def test_get_song_directory_error(self, mock_mkdir):
        ...
        with pytest.raises(ServiceError, match=f"Failed to create song directory for {song_id}"):
    ...
    def test_delete_song_files_error(self, mock_rmtree):
        ...
        with pytest.raises(ServiceError, match=f"Failed to delete files for song {song_id}"):
    ...
    def test_list_song_files_error(self, mock_iterdir):
        ...
        with pytest.raises(ServiceError, match=f"Failed to list files for song {song_id}"):
