...
class TestWebPFormatSupport:
    ...
    def test_download_image_webp_format_validation(self, mock_session_class):
        ...
        mock_response.iter_content.return_value = [b'RIFF\x1a\x00\x00\x00WEBP']  # WebP signature
        ...
        with patch('builtins.open', mock_open()) as mock_file, \
            ...
            # Act
            result = download_image("https://example.com/test.webp", Path("/test/path.webp"))
    ...
    def test_download_image_jpeg_signature_still_works(self, mock_session_class):
        ...
        with patch('builtins.open', mock_open()) as mock_file, \
            ...
            # Act
            result = download_image("https://example.com/test.jpg", Path("/test/path.jpg"))
    ...
    def test_download_image_png_signature_still_works(self, mock_session_class):
        ...
        with patch('builtins.open', mock_open()) as mock_file, \
            ...
            # Act
            result = download_image("https://example.com/test.png", Path("/test/path.png"))
    ...
    def test_download_image_rejects_invalid_format(self, mock_session_class):
        ...
        # Act
        result = download_image("https://example.com/not-image.html", Path("/test/path.jpg"))
...
class TestFormatDetectionEdgeCases:
    ...
    def test_download_image_malformed_webp_rejected(self, mock_session_class):
        ...
        # Act
        result = download_image("https://example.com/malformed.webp", Path("/test/path.webp"))
